package com.LeMinhBao;

import com.LeMinhBao.views.PrimaryView;
import com.LeMinhBao.views.SecondaryView;
...
public class ToDoApplication extends Application {
    ...
    private void postInit(Scene scene) {
        ...
        scene.getStylesheets().add(ToDoApplication.class.getResource("style.css").toExternalForm());
